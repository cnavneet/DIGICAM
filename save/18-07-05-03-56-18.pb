  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\005\000\000\000\005\000\000\000\010\000\000\000\020\000\000\000"
      }
    }
  }
}
...
node {
  name: "tf_layer2_weights/Assign"
  op: "Assign"
  input: "tf_layer2_weights"
...
node {
  name: "tf_layer2_biases/Assign"
  op: "Assign"
  input: "tf_layer2_biases"
  input: "Const_2"
  attr {
    key: "T"
    value {
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\002\000\000\000\016\000\000\000\016\000\000\000\010\000\000\000"
      }
    }
  }
}
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\002\000\000\000\007\000\000\000\007\000\000\000\020\000\000\000"
      }
    }
  }
}
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\002\000\000\000\004\000\000\000\004\000\000\000 \000\000\000"
      }
    }
  }
}
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\002\000\000\000\000\002\000\000"
      }
    }
  }
}
...
node {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/dropout_4/mul_grad/Mul"
      }
    }
  }
}
node {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/dropout_4/mul_grad/Mul_1"
      }
    }
  }
}
node {
  name: "gradients/dropout_4/div_grad/Shape"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/dropout_4/div_grad/Shape_1"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/dropout_4/div_grad/BroadcastGradientArgs"
  op: "BroadcastGradientArgs"
  input: "gradients/dropout_4/div_grad/Shape"
  input: "gradients/dropout_4/div_grad/Shape_1"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/dropout_4/div_grad/RealDiv"
  op: "RealDiv"
...
node {
  name: "gradients/dropout_4/div_grad/Sum"
  op: "Sum"
  input: "gradients/dropout_4/div_grad/RealDiv"
  input: "gradients/dropout_4/div_grad/BroadcastGradientArgs"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/dropout_4/div_grad/Reshape"
  op: "Reshape"
  input: "gradients/dropout_4/div_grad/Sum"
  input: "gradients/dropout_4/div_grad/Shape"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/dropout_4/div_grad/Neg"
  op: "Neg"
  input: "Relu_3"
  attr {
    key: "T"
...
node {
  name: "gradients/dropout_4/div_grad/RealDiv_1"
  op: "RealDiv"
  input: "gradients/dropout_4/div_grad/Neg"
  input: "dropout_4/keep_prob"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/dropout_4/div_grad/RealDiv_2"
  op: "RealDiv"
  input: "gradients/dropout_4/div_grad/RealDiv_1"
  input: "dropout_4/keep_prob"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/dropout_4/div_grad/mul"
  op: "Mul"
  input: "gradients/dropout_4/mul_grad/tuple/control_dependency"
  input: "gradients/dropout_4/div_grad/RealDiv_2"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/dropout_4/div_grad/Sum_1"
  op: "Sum"
  input: "gradients/dropout_4/div_grad/mul"
  input: "gradients/dropout_4/div_grad/BroadcastGradientArgs:1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/dropout_4/div_grad/Reshape_1"
  op: "Reshape"
  input: "gradients/dropout_4/div_grad/Sum_1"
  input: "gradients/dropout_4/div_grad/Shape_1"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/dropout_4/div_grad/tuple/group_deps"
  op: "NoOp"
  input: "^gradients/dropout_4/div_grad/Reshape"
  input: "^gradients/dropout_4/div_grad/Reshape_1"
}
node {
  name: "gradients/dropout_4/div_grad/tuple/control_dependency"
  op: "Identity"
  input: "gradients/dropout_4/div_grad/Reshape"
  input: "^gradients/dropout_4/div_grad/tuple/group_deps"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/dropout_4/div_grad/Reshape"
      }
    }
  }
}
node {
  name: "gradients/dropout_4/div_grad/tuple/control_dependency_1"
  op: "Identity"
  input: "gradients/dropout_4/div_grad/Reshape_1"
  input: "^gradients/dropout_4/div_grad/tuple/group_deps"
  attr {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/dropout_4/div_grad/Reshape_1"
      }
    }
  }
}
node {
  ...
  op: "ReluGrad"
  input: "gradients/dropout_4/div_grad/tuple/control_dependency"
  input: "Relu_3"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/Conv2D_2_grad/Const_1"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  ...
  input: "dropout_2/mul"
  input: "gradients/Conv2D_2_grad/Const_1"
  input: "gradients/add_2_grad/tuple/control_dependency"
  attr {
    key: "T"
    value {
  ...
  attr {
    ...
    value {
      tensor {
        ...
        tensor_content: "\002\000\000\000\034\000\000\000\034\000\000\000\010\000\000\000"
      }
    }
  }
}
...
node {
  name: "tf_optimizer/update_tf_layer2_weights/ApplyGradientDescent"
  op: "ApplyGradientDescent"
  input: "tf_layer2_weights"
  input: "tf_optimizer/learning_rate"
...
node {
  name: "tf_optimizer/update_tf_layer2_biases/ApplyGradientDescent"
  op: "ApplyGradientDescent"
  input: "tf_layer2_biases"
  input: "tf_optimizer/learning_rate"
...
node {
  ...
  input: "^tf_optimizer/update_tf_layer2_biases/ApplyGradientDescent"
  input: "^tf_optimizer/update_tf_layer2_weights/ApplyGradientDescent"
...
node {
  ...
  input: "^tf_layer2_biases/Assign"
  input: "^tf_layer2_weights/Assign"
  ...
  attr {
    ...
    value {
      tensor {
        ...
        string_val: "tf_layer2_biases"
        string_val: "tf_layer2_weights"
